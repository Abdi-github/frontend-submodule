...
export const USER_UPDATE_PROFILE_DETAILS_REQUEST =
  "USER_UPDATE_PROFILE_DETAILS_REQUEST";
export const USER_UPDATE_PROFILE_DETAILS_SUCCESS =
  "USER_UPDATE_PROFILE_DETAILS_SUCCESS";
export const USER_UPDATE_PROFILE_DETAILS_FAIL =
  "USER_UPDATE_PROFILE_DETAILS_FAIL";
export const USER_UPDATE_PROFILE_DETAILS_RESET =
